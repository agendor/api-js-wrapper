...
describe('Use Agendor Wrapper to insert a deal with stage "Contact"', function(){
    ...
    describe('when inserting a person:', function(){
        ...
        describe('when inserting a person AND an organization:', function() {
            var deal = {
                title: 'Contact this organization',
                description: 'This organization was inserted through the contact form in our web site. Contact this organization',
                person: {
            ...
            it('should FAIL!!! But, who knows? someday we can change this...', function () {
                agendor.deal.add(deal, function (result) {
                    result.error.should.not.to.be.null;
                    result.error.message.should.not.to.be.null;
                    done();
                });
            });
        });

        describe('when person and organization are null:', function() {
            var deal = {
                title: 'Contact',
                description: 'This deal was created through the wrapper, without any person or organization related to it.',
                value: 99999.99
            };
            it('should return a deal with all fields inserted (including the person)', function () {
                agendor.deal.add(deal, function (result) {
